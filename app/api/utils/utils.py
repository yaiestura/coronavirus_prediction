...
def country_code(country):
    ...
    if country in data:
        ...
        if country in synonyms:
            ...
            print ("No country_code was found for '" + country + "'. Using '" + default_code + "'")
            return default_code
